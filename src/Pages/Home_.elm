...
update msg model =
    case msg of
        ...
        -- Game mode messages
        SwitchToCalculatorMode ->
            ( { model | mode = CalculatorMode }, Effect.none )

        SwitchToGameMode ->
            ( { model | mode = GameMode }, Effect.none )
...
calculatorModeView : Model -> Html Msg
calculatorModeView model =
    let
        hasStartedGame =
...
modeSwitcher : Model -> Html Msg
modeSwitcher model =
    div [ class "mode-switcher" ]
        [ button
            [ classList
                [ ( "mode-button", True )
                , ( "mode-button--active", model.mode == CalculatorMode )
                ]
        ...
        , button
            [ classList
                [ ( "mode-button", True )
                , ( "mode-button--active", model.mode == GameMode )
                ]
